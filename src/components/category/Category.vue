<template>
    <div>
        ...
        <el-breadcrumb separator-class="el-icon-arrow-right">
            ...
            <el-breadcrumb-item>父类型管理</el-breadcrumb-item>
        </el-breadcrumb>
        <!--卡片视图区域-->
        <el-card class="box-card">
            <el-row :gutter="20">
                ...
                <!--按钮区域-->
                <el-col :span="4">
                    <el-button type="primary" @click="addDialogVisible=true">添加商品父类型</el-button>
                </el-col>
            </el-row>
            <!--列表区域-->
            <el-table :data="typeList" border stripe>
                <el-table-column type="index" label="#"/>
                <el-table-column label="父类型编号" prop="id"/>
                <el-table-column label="父类型名称" prop="name"/>
                <!--操作区域-->
        ...
        <el-dialog
                ...
                width="50%">
            <!--主体内容区域-->
            <el-form :model="typeForm" :rules="typeFormRules" ref="addFormRef" label-width="100px">
                <el-form-item label="父类型名称" prop="name">
        ...
        <el-dialog
                ...
                width="50%">
            <!--主体内容区域-->
            <el-form :model="type" :rules="typeFormRules" ref="editFormRef" label-width="100px">
                <el-form-item label="父类型名称" prop="name">
        ...
        <el-dialog
            ...
            <el-table :data="subCategory">
                <el-table-column property="id" label="子类型编号" width="100"/>
                <el-table-column property="name" label="子类型名称"/>
                <el-table-column label="子类型图片">
                    <template slot-scope="scope">
    ...
    export default {
        ...
        methods: {
            ...
            async getTypeById(row) {
                ...
                const result = await this.$http.get("http://localhost:8084/subType/getSubTypeByTypeId", {params: {id: row.id}});
                console.log(result);
